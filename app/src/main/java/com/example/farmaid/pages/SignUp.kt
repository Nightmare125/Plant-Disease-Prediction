...
fun SignUp(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel) {
    ...
    Column(
        ...
        TextButton(onClick = {
            ...
            Text(text = "ready have an account? Login")
        }


    }
}
//Unable to strip the following libraries, packaging them as they are: libimage_processing_util_jni.so, libtensorflowlite_gpu_jni.so, libtensorflowlite_jni.so.
